"""
Unified Gemini LLM client for the Insight Engine, with native caching and retry support.
"""
...
class LLMClient:
    """
    Native Gemini client with hybrid caching support for the Insight Engine.
    ...
    def __init__(
        ...
        """
        Initialize Gemini client for Insight Engine.
        ...
        **kwargs
        ...
        try:
            if cache:
                ...
                logger.debug("InsightEngine: Using explicit cached context")
                ...
                logger.debug("InsightEngine: Using implicit caching (standard request)")
            ...
            logger.error(f"InsightEngine generation failed: {e}")
            raise
    ...
    def stream_invoke(
        ...
        **kwargs
        ...
        try:
            ...
            logger.error(f"InsightEngine streaming failed: {e}")
            raise
